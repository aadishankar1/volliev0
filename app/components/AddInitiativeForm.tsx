  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">{user?.description || "No description provided"}</p>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center space-x-2">
          <Switch id="on-campus" checked={isOnCampus} onCheckedChange={setIsOnCampus} />
      ...
      <Button type="submit" className="w-full bg-vollie-blue hover:bg-vollie-blue/90 text-white">
        Add Initiative
      </Button>
    </form>
  )

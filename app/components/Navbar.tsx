...
import { LogOut, Globe, Bell, User, Plus, Award, ClipboardList, Calendar } from "lucide-react"
    ...
    <>
          ...
          <div className="flex justify-between items-center h-full">
            <div className="flex items-center">
              ...
              <div className="hidden md:flex ml-6 space-x-1">
                ...
                <NavLink href="/calendar-view" current={pathname} icon={<Calendar className="h-4 w-4" />}>
                  Calendar
                </NavLink>
                ...
                {user && (
                  <>
                    ...
                    {user.userType === 1 && (
                      <>
                        <NavLink href="/opportunity-management" current={pathname} icon={<ClipboardList className="h-4 w-4" />}>
      ...
      >
        <div className="grid grid-cols-5 h-full">
          ...
          <MobileNavLink href="/calendar-view" current={pathname} icon={<Calendar className="h-6 w-6" />} label="Calendar" />
          <MobileNavLink
            href="/notifications"
            current={pathname}
          ...
          {user && user.userType === 1 && (
            <MobileNavLink href="/opportunity-management" current={pathname} icon={<ClipboardList className="h-6 w-6" />} label="Manage" />
          )}
        </div>
      </motion.nav>
    </>
